...
${CXX:-c++} -std=c++17 -Wall -Wextra -Werror -pedantic \
  -I"$ROOT/firmware/include" "$ROOT/firmware/tests/connection_wait_display_test.cpp" \
  -o "$BUILD_DIR/connection_wait_display_test"
"$BUILD_DIR/connection_wait_display_test"
