...
- **S3: 5.6 mm** = 2.8 mm printed supports + 2.8 mm floor.
...
The S3 backs now provide four 2.8 mm-high printed pads instead of adhesive
supports; see its [assembly instructions](../esp32-s3-lcd-1.47b/README.md) for
the manufacturer-dimensioned screw positions and 4.3 mm screw grip. The board
